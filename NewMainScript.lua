...
local function downloadPremadeProfiles(commit)
	...
	local success, response = pcall(function()
		return game:HttpGet('https://api.github.com/repos/AverageClumzyPerson/AverageDeveloperScript/contents/profiles/premade?ref=' .. commit)
	end)
...
if not shared.VapeDeveloper then
	...
	local ok, res = pcall(function()
		return game:HttpGet('https://api.github.com/repos/AverageClumzyPerson/AverageDeveloperScript/commits/main', true)
	end)
	if ok and res then
