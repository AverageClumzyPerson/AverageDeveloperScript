...
local drawingactor = loadstring(downloadFile('newvape/libraries/drawing.lua'), 'drawing')(table.unpack(_ARGS))
local function notif(...)
	return vape:CreateNotification(...)
end

if not select(1, table.unpack(_ARGS)) and game.PlaceId == 5938036553 then
